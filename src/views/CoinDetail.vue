        ...
        <div class="my-10 flex flex-col">
          <ul>
            <li class="flex justify-between">
              <b class="text-gray-600 mr10 uppercase">Ranking</b>
          ...
          <div class="flex flex-row my-5">
            <label for="convertValue" class="w-full">
              <input
                ...
                type="number"
                id="convertValue"
                class="text-center bg-white focus:shadow-outline border border-gray-300 rounded-lg py-2 px-4 block w-full appearence-none leading-normal"
